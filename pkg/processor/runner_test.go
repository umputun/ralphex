...
func TestRunner_Run_UnknownMode(t *testing.T) {
	...
	r := processor.NewWithExecutors(processor.Config{Mode: "invalid"}, log, claude, codex, nil, nil)
...
func TestRunner_RunFull_NoPlanFile(t *testing.T) {
	...
	r := processor.NewWithExecutors(processor.Config{Mode: processor.ModeFull}, log, claude, codex, nil, nil)
	err := r.Run(context.Background())
...
func TestRunner_RunFull_Success(t *testing.T) {
	...
	r := processor.NewWithExecutors(cfg, log, claude, codex, nil, nil)
	err := r.Run(context.Background())
...
func TestRunner_RunTasksOnly_NoPlanFile(t *testing.T) {
	...
	r := processor.NewWithExecutors(processor.Config{Mode: processor.ModeTasksOnly}, log, claude, codex, nil, nil)
	err := r.Run(context.Background())
...
func TestRunner_ExternalReviewTool_Custom_Success(t *testing.T) {
	...
	r := processor.NewWithExecutors(cfg, log, claude, codex, customExec, nil)
	err := r.Run(context.Background())
